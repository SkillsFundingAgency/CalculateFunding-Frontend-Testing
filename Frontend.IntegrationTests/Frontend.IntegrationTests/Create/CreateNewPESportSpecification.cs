namespace Frontend.IntegrationTests.Create
{
    ...
    [Binding]
    public static class CreateNewPESportSpecification

    {

        public static void CreateANewPESportSpecification()

        {
            ...
            createspecificationpage.SpecFundingStreamTextField.SendKeys("PE and Sport Premium");
