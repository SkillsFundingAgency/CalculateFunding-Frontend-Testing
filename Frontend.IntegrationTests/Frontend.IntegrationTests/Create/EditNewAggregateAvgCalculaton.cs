...
{
    [Binding]
    public static class EditNewAggregateAvgCalculaton
    {
        public static void EditANewAggregateAvgCalculaton()

        {
            ...
            Thread.Sleep(2000);
            editcalculationspage.CalculationVBTextEditor.SendKeys("Return Sum(" + specCalcCreated + ") + Avg(" + specCalcCreated + ")");
            Thread.Sleep(2000);
