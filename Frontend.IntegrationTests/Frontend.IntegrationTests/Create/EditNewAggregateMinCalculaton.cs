...
{
    [Binding]
    public static class EditNewAggregateMinCalculaton
    {
        public static void EditANewAggregateMinCalculaton()

        {
            ...
            Thread.Sleep(2000);
            editcalculationspage.CalculationVBTextEditor.SendKeys("Return Sum(" + specCalcCreated + ") + Min(" + specCalcCreated + ")");
            Thread.Sleep(2000);
