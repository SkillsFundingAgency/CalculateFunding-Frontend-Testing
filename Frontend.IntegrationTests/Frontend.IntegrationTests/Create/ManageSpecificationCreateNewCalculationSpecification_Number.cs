...
{
    [Binding]
    public static class ManageSpecificationCreateNewCalculationSpecification_Number
    {
        public static void CreateANewSpecificationPolicy_Number()

        {
            ...
            string newname = "TestNumberCalculationName";
