...
namespace Frontend.IntegrationTests.Pages.Manage_Datasets
{
    public class SelectedSpecificationDataSourcePage
    {
        ...
        [FindsBy(How = How.CssSelector, Using = "#top > main:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > p:nth-child(2)")]
        ...
        [FindsBy(How = How.CssSelector, Using = "#top > main:nth-child(4) > div:nth-child(1) > div:nth-child(1) > div:nth-child(1) > p:nth-child(6)")]
